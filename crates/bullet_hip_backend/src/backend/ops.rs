...
unsafe extern "C" {
    ...
    pub fn Adam(size: usize, beta1: f32, beta2: f32, adj: f32, rate: f32, eps: f32, denom: bool, decay: f32, min: f32, max: f32, network: *mut f32, momentum: *mut f32, velocity: *mut f32, gradients: *const f32);
